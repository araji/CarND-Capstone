...
class WaypointUpdater(object):
    def __init__(self):
        ...
        # base_lane  is built by first call to /base_waypoints callback 
        self.base_lane =  None
        self.pose = None
    ...
    def generate_lane(self):
        ...
        # only slow down if red light is within lookahead distance
        # otherwise return base waypoints
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            stop_idx = max(self.stopline_wp_idx - closest_idx - 4, 0) # 4  waypoints from line for now
    ...
    # called only once after that we use the KDTree to locate position and points ahead.
